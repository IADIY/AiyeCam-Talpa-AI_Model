...
#define WITH_ULOADER 0

/**
 * TOKEN
 * @TokenName PROJECT_TAG
 * @Help		Project firmware image naming.
 * @TokenType   Expression
 * @Master		Yes
 * @Dependency  NULL
 */
#define PROJECT_TAG "face_detection_uart"

// @END

/**
 * TOKEN
 * @TokenName   PROJECT_MAJOR_VERSION
...
/**
 * TOKEN
 * @TokenName   PROJECT_MINOR_VERSION
...
/**
 * TOKEN
 * @TokenName   PROJECT_TEST_VERSION
 * @Help		Project firmware image test version(a, b, c,...).
 * @TokenType   Expression
 * @Master		Yes
 * @Dependency  NULL
 */
#define PROJECT_TEST_VERSION "a"
...
#undef SYS_WORK_FREQ
#endif
#define SYS_WORK_FREQ SUPPORT_SYS_80M
 ...
 * @Dependency  NULL
 */
#define DEBUG_BOX_TOTAL_ENABLE ENABLE
...
#else
#define DEBUG_BOX_NUM_0_ENABLE DISABLE
...
#else
#define DEBUG_BOX_NUM_1_ENABLE DISABLE
#endif // #if DEBUG_BOX_TOTAL_ENABLE == ENABLE
// @END
...
#else
#define DEBUG_BOX_NUM_2_ENABLE DISABLE
#endif // #if DEBUG_BOX_TOTAL_ENABLE == ENABLE
// @END
...
#else
#define DEBUG_BOX_NUM_3_ENABLE DISABLE
#endif // #if DEBUG_BOX_TOTAL_ENABLE == ENABLE
// @END
...
#else
#define DEBUG_BOX_NUM_4_ENABLE DISABLE
#endif // #if DEBUG_BOX_TOTAL_ENABLE == ENABLE
// @END
...
#define AEG_MODE MACR_AEG_APPLICATION_PROJECT_CUSTOM

// @END

/**
 * TOKEN
 * @TokenName	AEG_AC_POWER_FREQ
...
#define AEG_LED_LIGHT_CTRL_MIN 20
...
#define AEG_BRIGHTNESS_TARGET_VAULE 130
